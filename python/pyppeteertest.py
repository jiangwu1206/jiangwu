...
async def main(page):
    ...
    # 详情参考来源 https://blog.csdn.net/weixin_41624982/article/details/89668879
    await page.evaluateOnNewDocument('() =>{ Object.defineProperties(navigator,'
                                     '{ webdriver:{ get: () => false } }) }')
    # 加载目标网站
    await page.goto('https://www.amazon.com/s?k=watches&ref=nb_sb_noss_2')
    # await page.waitForXPath("//div[@class='a-section aok-relative s-image-square-aspect']/img/@src")
    ...
    res = html_x.xpath("//div[@class='a-section aok-relative s-image-square-aspect']/img/@src")
    for i in res:
        print(i)
    ...
    # 输入文字，选取按照selector去定位元素
    # await page.type('#kw', '陆壹佛爷')

    # 点击事件，选取按照selector去定位元素
    # await page.click('#su')
